...
# ✅ MongoDB — accepte MONGO_URI ou MONGO_URL (Railway peut utiliser l'un ou l'autre)
MONGO_URI = (
...
# ✅ MongoClient protégé — ne plante pas au démarrage si l'URI est absent
try:
    MONGO_CLIENT = MongoClient(MONGO_URI, serverSelectionTimeoutMS=5000)
    MONGO_DB = MONGO_CLIENT[MONGO_DB_NAME]
except Exception as e:
    import logging
    logging.warning(f"MongoDB connection failed at startup: {e}")
    MONGO_CLIENT = None
    MONGO_DB = None
...
DEFAULT_FROM_EMAIL = f"SIGR-CA <{os.environ.get('EMAIL_USER', 'lafin2626@gmail.com')}>"

# ✅ CSRF — couvre localhost + tous les domaines Railway
